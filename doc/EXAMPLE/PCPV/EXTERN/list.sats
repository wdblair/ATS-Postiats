...
(**
  ...
  the standard library. This allows us to refine lists for 
  "critical" functionality where extra automated reasoning is 
  desired, but also provide flexibility for the user.
*)
castfn list_stampseq_of_list {a:t@ype}{n:int} (
  xs: list (a, n)
): [xs:stampseq] list (a, xs, n)

castfn list_of_list_stampseq {a:t@ype}{xs:stampseq}{n:int} (
  xs: list (a, xs, n)
): list (a, n)
