...
ATSextern_val(ats_int_type, _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
ATSextern_val(ats_int_type, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
ATSextern_val(ats_int_type, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
ATSextern_fun(ats_uint_type, _2opt_2postiats_2src_2pats_effect_2esats__effset_add) (ats_uint_type, ats_int_type) ;
ATSextern_fun(ats_uint_type, _2opt_2postiats_2src_2pats_effect_2esats__effset_del) (ats_uint_type, ats_int_type) ;
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 1631(line=50, offs=4) -- 1709(line=51, offs=44)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 1713(line=52, offs=4) -- 1791(line=53, offs=44)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 1796(line=55, offs=4) -- 1880(line=56, offs=50)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 1885(line=58, offs=4) -- 1971(line=59, offs=52)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 1975(line=60, offs=4) -- 2060(line=61, offs=52)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2064(line=62, offs=4) -- 2146(line=63, offs=48)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2151(line=65, offs=4) -- 2204(line=65, offs=57)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2208(line=66, offs=4) -- 2261(line=66, offs=57)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2265(line=67, offs=4) -- 2324(line=67, offs=63)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2328(line=68, offs=4) -- 2381(line=68, offs=57)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2413(line=73, offs=4) -- 2461(line=73, offs=52)
*/
ATSstaticdec()
ats_bool_type
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 2557(line=83, offs=4) -- 2855(line=94, offs=2)
*/
ATSstaticdec()
ats_void_type
...
/* tmp20 = */ _2opt_2postiats_2src_2pats_location_2esats__prerr_location (tmp19) ;
...
/* tmp18 = */ _2opt_2postiats_2src_2pats_error_2esats__abort () ;
return /* (tmp18) */ ;
} /* end of [loop_err_11] */

/*
// /opt/postiats/src/pats_trans1_effect.dats: 2882(line=96, offs=5) -- 7361(line=218, offs=4)
*/
ATSstaticdec()
ats_void_type
...
if (tmp35) {
ats_ptrget_mac(ats_uint_type, arg3) = _2opt_2postiats_2src_2pats_effect_2esats__effset_nil ;
} else {
/* empty */
} /* end of [if] */
tmp36 = atspre_eq_int_int (tmp33, 1) ;
if (tmp36) {
ats_ptrget_mac(ats_uint_type, arg3) = _2opt_2postiats_2src_2pats_effect_2esats__effset_all ;
} else {
/* empty */
} /* end of [if] */
break ;
...
if (tmp49) {
tmp50 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (_2opt_2postiats_2src_2pats_effect_2esats__effset_nil, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
...
if (tmp51) {
tmp52 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (_2opt_2postiats_2src_2pats_effect_2esats__effset_all, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
...
if (tmp57) {
tmp58 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_ntm) ;
...
if (tmp59) {
tmp60 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_ntm) ;
...
if (tmp63) {
tmp64 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
...
if (tmp65) {
tmp66 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
...
if (tmp69) {
tmp70 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
...
if (tmp71) {
tmp72 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
...
if (tmp75) {
tmp76 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp77) {
tmp78 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp81) {
tmp83 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
tmp82 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (tmp83, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
...
if (tmp84) {
tmp86 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
tmp85 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (tmp86, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
...
if (tmp89) {
tmp91 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
tmp90 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (tmp91, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp92) {
tmp94 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
tmp93 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (tmp94, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp97) {
tmp100 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
tmp99 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (tmp100, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
tmp98 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (tmp99, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp101) {
tmp104 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_exn) ;
tmp103 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (tmp104, _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
tmp102 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (tmp103, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp107) {
tmp109 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
tmp108 = _2opt_2postiats_2src_2pats_effect_2esats__effset_del (tmp109, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
if (tmp110) {
tmp112 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (ats_ptrget_mac(ats_uint_type, arg3), _2opt_2postiats_2src_2pats_effect_2esats__effect_ref) ;
tmp111 = _2opt_2postiats_2src_2pats_effect_2esats__effset_add (tmp112, _2opt_2postiats_2src_2pats_effect_2esats__effect_wrt) ;
...
/*
// /opt/postiats/src/pats_trans1_effect.dats: 7430(line=224, offs=3) -- 7911(line=249, offs=4)
*/
ATSglobaldec()
anairiats_rec_9
_2opt_2postiats_2src_2pats_trans1_2esats__e0fftaglst_tr (ats_ptr_type arg0) {
/* local vardec */
...
__ats_lab__2opt_2postiats_2src_2pats_trans1_2esats__e0fftaglst_tr:
/* ats_ptr_type tmp131 ; */
...
tmp134 = _2opt_2postiats_2src_2pats_effect_2esats__effset_nil ;
/* ats_ptr_type tmp135 ; */
tmp135 = statmp17 ;
...
__ats_lab_21_0:
__ats_lab_21_1:
tmp138 = _2opt_2postiats_2src_2pats_effect_2esats__eq_effset_effset (tmp134, _2opt_2postiats_2src_2pats_effect_2esats__effset_all) ;
if (!tmp138) { goto __ats_lab_22_1 ; }
tmp137 = (ats_sum_ptr_type)(&_2opt_2postiats_2src_2pats_staexp1_2esats__EFFCSTall_0) ;
break ;

/* branch: __ats_lab_22 */
__ats_lab_22_0:
__ats_lab_22_1:
tmp139 = _2opt_2postiats_2src_2pats_effect_2esats__eq_effset_effset (tmp134, _2opt_2postiats_2src_2pats_effect_2esats__effset_nil) ;
...
__ats_lab_23_1:
tmp137 = (ats_sum_ptr_type)(&_2opt_2postiats_2src_2pats_staexp1_2esats__EFFCSTnil_1) ;
break ;
...
return (tmp130) ;
} /* end of [_2opt_2postiats_2src_2pats_trans1_2esats__e0fftaglst_tr] */

#ifdef _ATS_AVR

#define _2opt_2postiats_2src_2pats_trans1_effect_2edats__staload() 
...
ats_void_type
_2opt_2postiats_2src_2pats_trans1_effect_2edats__staload () {
static int _2opt_2postiats_2src_2pats_trans1_effect_2edats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_trans1_effect_2edats__staload_flag) return ;
_2opt_2postiats_2src_2pats_trans1_effect_2edats__staload_flag = 1 ;
...
extern ats_int_type _2opt_2postiats_2src_2pats_trans1_effect_2edats__dynload_flag ;

ats_void_type
_2opt_2postiats_2src_2pats_trans1_effect_2edats__dynload () {
_2opt_2postiats_2src_2pats_trans1_effect_2edats__dynload_flag = 1 ;
_2opt_2postiats_2src_2pats_trans1_effect_2edats__staload () ;
...
/* end of [/opt/postiats/src/pats_trans1_effect_dats.c] */
