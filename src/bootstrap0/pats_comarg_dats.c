...
ATSextern_fun(ats_void_type, _2opt_2postiats_2src_2pats_global_2esats__the_IATS_dirlst_ppush) (ats_ptr_type) ;
...
ATSextern_fun(ats_ptr_type, _2opt_2postiats_2src_2pats_parsing_2esats__p_datsdef) (ats_ref_type, ats_int_type, ats_ref_type) ;
ATSextern_fun(ats_ptr_type, _2opt_2postiats_2src_2pats_parsing_2esats__parse_from_string) (ats_ptr_type, ats_ptr_type) ;
...
ATSextern_fun(ats_ptr_type, _2opt_2postiats_2src_2pats_comarg_2esats__comarg_parse) (ats_ptr_type) ;
...
/*
// /opt/postiats/src/pats_comarg.dats: 1893(line=60, offs=7) -- 2134(line=66, offs=8)
*/
ATSstaticdec()
ats_ptr_type
...
/*
// /opt/postiats/src/pats_comarg.dats: 1877(line=59, offs=14) -- 2273(line=72, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2opt_2postiats_2src_2pats_comarg_2esats__comarg_parse (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp0) ;
ATSlocal (ats_size_type, tmp6) ;
ATSlocal (ats_int_type, tmp7) ;

__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__comarg_parse:
...
return (tmp0) ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__comarg_parse] */

/*
// /opt/postiats/src/pats_comarg.dats: 2430(line=80, offs=7) -- 2897(line=91, offs=24)
*/
ATSstaticdec()
ats_void_type
...
tmp12 = _2opt_2postiats_2src_2pats_comarg_2esats__comarg_parse (tmp13) ;
...
/*
// /opt/postiats/src/pats_comarg.dats: 2353(line=78, offs=7) -- 3044(line=97, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2opt_2postiats_2src_2pats_comarg_2esats__comarglst_parse (ats_int_type arg0, ats_ref_type arg1) {
/* local vardec */
...
__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__comarglst_parse:
/* ats_ptr_type tmp20 ; */
...
tmp8 = tmp20 ;
return (tmp8) ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__comarglst_parse] */

/*
// /opt/postiats/src/pats_comarg.dats: 3120(line=102, offs=16) -- 3310(line=108, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_comarg_2esats__comarg_warning (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp23) ;
// ATSlocal_void (tmp24) ;
// ATSlocal_void (tmp25) ;
...
__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__comarg_warning:
...
return /* (tmp23) */ ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__comarg_warning] */

/*
// /opt/postiats/src/pats_comarg.dats: 3383(line=113, offs=14) -- 3447(line=114, offs=56)
*/
ATSglobaldec()
ats_bool_type
_2opt_2postiats_2src_2pats_comarg_2esats__is_DATS_flag (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_bool_type, tmp28) ;
ATSlocal (ats_bool_type, tmp29) ;
ATSlocal (ats_int_type, tmp30) ;

__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__is_DATS_flag:
...
return (tmp28) ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__is_DATS_flag] */

/*
// /opt/postiats/src/pats_comarg.dats: 3497(line=118, offs=14) -- 3561(line=119, offs=56)
*/
ATSglobaldec()
ats_bool_type
_2opt_2postiats_2src_2pats_comarg_2esats__is_IATS_flag (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_bool_type, tmp31) ;
ATSlocal (ats_bool_type, tmp32) ;
ATSlocal (ats_int_type, tmp33) ;

__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__is_IATS_flag:
...
return (tmp31) ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__is_IATS_flag] */

/*
// /opt/postiats/src/pats_comarg.dats: 3619(line=126, offs=4) -- 3962(line=142, offs=4)
*/
ATSstaticdec()
ats_ptr_type
...
/*
// /opt/postiats/src/pats_comarg.dats: 4028(line=147, offs=14) -- 4063(line=147, offs=49)
*/
ATSglobaldec()
ats_ptr_type
_2opt_2postiats_2src_2pats_comarg_2esats__DATS_extract (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp39) ;

__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__DATS_extract:
tmp39 = string_extract_7 (arg0, 5) ;
return (tmp39) ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__DATS_extract] */

/*
// /opt/postiats/src/pats_comarg.dats: 4087(line=149, offs=14) -- 4122(line=149, offs=49)
*/
ATSglobaldec()
ats_ptr_type
_2opt_2postiats_2src_2pats_comarg_2esats__IATS_extract (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp40) ;

__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__IATS_extract:
tmp40 = string_extract_7 (arg0, 5) ;
return (tmp40) ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__IATS_extract] */

/*
// /opt/postiats/src/pats_comarg.dats: 4195(line=156, offs=18) -- 4888(line=183, offs=4)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_comarg_2esats__process_DATS_def (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp41) ;
...
__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__process_DATS_def:
tmp42 = _2opt_2postiats_2src_2pats_parsing_2esats__parse_from_string (ats_castfn_mac(ats_ptr_type, arg0), &_2opt_2postiats_2src_2pats_parsing_2esats__p_datsdef) ;
do {
/* branch: __ats_lab_0 */
__ats_lab_0_0:
...
tmp46 = _2opt_2postiats_2src_2pats_trans1_2esats__e0xp_tr (tmp47) ;
break ;
...
__ats_lab_2_1:
tmp46 = _2opt_2postiats_2src_2pats_staexp1_2esats__e1xp_none (_2opt_2postiats_2src_2pats_location_2esats__location_dummy) ;
break ;
} while (0) ;
/* tmp41 = */ _2opt_2postiats_2src_2pats_trans1_env_2esats__the_e1xpenv_add (tmp44, tmp46) ;
break ;
...
/* tmp41 = */ _2opt_2postiats_2src_2pats_error_2esats__abort () ;
break ;
} while (0) ;
return /* (tmp41) */ ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__process_DATS_def] */

/*
// /opt/postiats/src/pats_comarg.dats: 4946(line=186, offs=18) -- 5062(line=191, offs=4)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_comarg_2esats__process_IATS_dir (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp53) ;
// ATSlocal_void (tmp54) ;

__ats_lab__2opt_2postiats_2src_2pats_comarg_2esats__process_IATS_dir:
/* tmp54 = */ _2opt_2postiats_2src_2pats_filename_2esats__the_pathlst_ppush (arg0) ;
/* tmp53 = */ _2opt_2postiats_2src_2pats_global_2esats__the_IATS_dirlst_ppush (arg0) ;
return /* (tmp53) */ ;
} /* end of [_2opt_2postiats_2src_2pats_comarg_2esats__process_IATS_dir] */

#ifdef _ATS_AVR

#define _2opt_2postiats_2src_2pats_comarg_2edats__staload() 
...
ats_void_type
_2opt_2postiats_2src_2pats_comarg_2edats__staload () {
static int _2opt_2postiats_2src_2pats_comarg_2edats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_comarg_2edats__staload_flag) return ;
_2opt_2postiats_2src_2pats_comarg_2edats__staload_flag = 1 ;
...
extern ats_int_type _2opt_2postiats_2src_2pats_comarg_2edats__dynload_flag ;

ats_void_type
_2opt_2postiats_2src_2pats_comarg_2edats__dynload () {
_2opt_2postiats_2src_2pats_comarg_2edats__dynload_flag = 1 ;
_2opt_2postiats_2src_2pats_comarg_2edats__staload () ;
...
/* end of [/opt/postiats/src/pats_comarg_dats.c] */
