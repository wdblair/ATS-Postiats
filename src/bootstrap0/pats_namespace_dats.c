...
/*
// /opt/postiats/src/pats_namespace.dats: 1735(line=55, offs=4) -- 1797(line=56, offs=47)
*/
ATSstaticdec()
ats_void_type
...
/* tmp0 = */ list_vt_free_01829_ats_ptr_type (arg0) ;
return /* (tmp0) */ ;
} /* end of [fenvlst_vt_free_0] */

/*
// /opt/postiats/src/pats_namespace.dats: 1802(line=57, offs=5) -- 2051(line=63, offs=26)
*/
ATSstaticdec()
ats_void_type
...
/*
// /opt/postiats/src/pats_namespace.dats: 2316(line=78, offs=3) -- 2447(line=83, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_add (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp16) ;
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_add:
...
ats_selptrset_mac(anairiats_sum_0, tmp18, atslab_1, tmp19) ;
ats_ptrget_mac(ats_ptr_type, tmp17) = tmp18 ;
return /* (tmp16) */ ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_add] */

/*
// /opt/postiats/src/pats_namespace.dats: 2610(line=92, offs=7) -- 2863(line=99, offs=32)
*/
ATSstaticdec()
ats_ptr_type
...
tmp23 = ats_caselptrlab_mac(anairiats_sum_0, arg1, atslab_1) ;
...
/*
// /opt/postiats/src/pats_namespace.dats: 2918(line=102, offs=7) -- 3203(line=110, offs=32)
*/
ATSstaticdec()
ats_ptr_type
...
tmp27 = ats_caselptrlab_mac(anairiats_sum_0, arg1, atslab_1) ;
...
/*
// /opt/postiats/src/pats_namespace.dats: 2516(line=87, offs=7) -- 3609(line=125, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_search (ats_clo_ptr_type arg0) {
/* local vardec */
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_search:
...
return (tmp20) ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_search] */

/*
// /opt/postiats/src/pats_namespace.dats: 3693(line=130, offs=19) -- 4020(line=144, offs=4)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_pop () {
/* local vardec */
// ATSlocal_void (tmp32) ;
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_pop:
tmp33 = ats_selsin_mac(ats_castfn_mac(ats_ptr_type, statmp12), atslab_1) ;
tmp34 = ats_ptrget_mac(ats_ptr_type, tmp33) ;
if (tmp34 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/opt/postiats/src/pats_namespace.dats: 3790(line=133, offs=9) -- 3818(line=133, offs=37)") ; }
tmp35 = ats_caselptrlab_mac(anairiats_sum_0, tmp34, atslab_0) ;
tmp36 = ats_caselptrlab_mac(anairiats_sum_0, tmp34, atslab_1) ;
ATS_FREE(tmp34) ;
...
return /* (tmp32) */ ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_pop] */

/*
// /opt/postiats/src/pats_namespace.dats: 4081(line=147, offs=20) -- 4381(line=159, offs=4)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_push () {
/* local vardec */
// ATSlocal_void (tmp39) ;
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_push:
...
ats_selptrset_mac(anairiats_sum_0, tmp44, atslab_0, tmp41) ;
ats_selptrset_mac(anairiats_sum_0, tmp44, atslab_1, tmp45) ;
ats_ptrget_mac(ats_ptr_type, tmp43) = tmp44 ;
return /* (tmp39) */ ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_push] */
...
__ats_lab_14_1:
tmp59 = &ats_caselptrlab_mac(anairiats_sum_0, ats_ptrget_mac(ats_ptr_type, arg0), atslab_1) ;
arg0 = tmp59 ;
arg1 = arg1 ;
...
/*
// /opt/postiats/src/pats_namespace.dats: 4469(line=164, offs=25) -- 4875(line=178, offs=4)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_localjoin () {
/* local vardec */
// ATSlocal_void (tmp46) ;
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_localjoin:
tmp47 = ats_selsin_mac(ats_castfn_mac(ats_ptr_type, statmp12), atslab_1) ;
tmp48 = ats_ptrget_mac(ats_ptr_type, tmp47) ;
if (tmp48 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/opt/postiats/src/pats_namespace.dats: 4568(line=167, offs=9) -- 4597(line=167, offs=38)") ; }
tmp49 = ats_caselptrlab_mac(anairiats_sum_0, tmp48, atslab_0) ;
tmp50 = ats_caselptrlab_mac(anairiats_sum_0, tmp48, atslab_1) ;
ATS_FREE(tmp48) ;
/* tmp51 = */ fenvlst_vt_free_0 (tmp49) ;
if (tmp50 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/opt/postiats/src/pats_namespace.dats: 4641(line=169, offs=9) -- 4671(line=169, offs=39)") ; }
tmp52 = ats_caselptrlab_mac(anairiats_sum_0, tmp50, atslab_0) ;
tmp53 = ats_caselptrlab_mac(anairiats_sum_0, tmp50, atslab_1) ;
ATS_FREE(tmp50) ;
...
tmp55 = list_vt_append_01834_ats_ptr_type (tmp61, tmp52) ;
ats_ptrget_mac(ats_ptr_type, tmp54) = tmp55 ;
return /* (tmp46) */ ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_localjoin] */

/*
// /opt/postiats/src/pats_namespace.dats: 4963(line=183, offs=20) -- 5437(line=200, offs=4)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_save () {
/* local vardec */
// ATSlocal_void (tmp62) ;
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_save:
...
ats_selptrset_mac(anairiats_sum_2, tmp70, atslab_0, tmp71) ;
ats_selptrset_mac(anairiats_sum_2, tmp70, atslab_1, tmp72) ;
ats_ptrget_mac(ats_ptr_type, tmp69) = tmp70 ;
return /* (tmp62) */ ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_save] */

/*
// /opt/postiats/src/pats_namespace.dats: 5504(line=204, offs=3) -- 6000(line=230, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_restore () {
/* local vardec */
// ATSlocal_void (tmp73) ;
...
__ats_lab__2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_restore:
tmp74 = ats_selsin_mac(ats_castfn_mac(ats_ptr_type, statmp14), atslab_1) ;
tmp75 = ats_ptrget_mac(ats_ptr_type, tmp74) ;
if (tmp75 == (ats_sum_ptr_type)0) { ats_caseof_failure_handle ("/opt/postiats/src/pats_namespace.dats: 5609(line=210, offs=7) -- 5635(line=210, offs=33)") ; }
tmp76 = ats_caselptrlab_mac(anairiats_sum_2, tmp75, atslab_0) ;
tmp77 = ats_caselptrlab_mac(anairiats_sum_2, tmp75, atslab_1) ;
ATS_FREE(tmp75) ;
...
return /* (tmp73) */ ;
} /* end of [_2opt_2postiats_2src_2pats_namespace_2esats__the_namespace_restore] */

#ifdef _ATS_AVR

#define _2opt_2postiats_2src_2pats_namespace_2edats__staload() 
...
ats_void_type
_2opt_2postiats_2src_2pats_namespace_2edats__staload () {
static int _2opt_2postiats_2src_2pats_namespace_2edats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_namespace_2edats__staload_flag) return ;
_2opt_2postiats_2src_2pats_namespace_2edats__staload_flag = 1 ;
...
extern ats_int_type _2opt_2postiats_2src_2pats_namespace_2edats__dynload_flag ;

ats_void_type
_2opt_2postiats_2src_2pats_namespace_2edats__dynload () {
_2opt_2postiats_2src_2pats_namespace_2edats__dynload_flag = 1 ;
_2opt_2postiats_2src_2pats_namespace_2edats__staload () ;
...
statmp8 = ref_01264_ats_ptr_type (statmp11) ;
statmp13 = (ats_sum_ptr_type)0 ;
statmp12 = ref_01264_ats_ptr_type (statmp13) ;
statmp15 = (ats_sum_ptr_type)0 ;
statmp14 = ref_01264_ats_ptr_type (statmp15) ;
return ;
...
/* end of [/opt/postiats/src/pats_namespace_dats.c] */
