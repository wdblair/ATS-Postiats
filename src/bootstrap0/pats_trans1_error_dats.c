...
static
ats_ptr_type the_trans1errlst_get_1 () ;
static
...
/*
// /opt/postiats/src/pats_trans1_error.dats: 1749(line=58, offs=5) -- 1913(line=65, offs=4)
*/
ATSstaticdec()
ats_ptr_type
the_trans1errlst_get_1 () {
/* local vardec */
...
__ats_lab_the_trans1errlst_get_1:
...
tmp4 = tmp6 ;
return (tmp4) ;
} /* end of [the_trans1errlst_get_1] */

/*
// /opt/postiats/src/pats_trans1_error.dats: 2002(line=71, offs=3) -- 2116(line=74, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_trans1_2esats__the_trans1errlst_add (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp8) ;
...
__ats_lab__2opt_2postiats_2src_2pats_trans1_2esats__the_trans1errlst_add:
...
return /* (tmp8) */ ;
} /* end of [_2opt_2postiats_2src_2pats_trans1_2esats__the_trans1errlst_add] */
...
/*
// /opt/postiats/src/pats_trans1_error.dats: 2187(line=77, offs=27) -- 2457(line=86, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_trans1_2esats__the_trans1errlst_finalize () {
/* local vardec */
// ATSlocal_void (tmp12) ;
...
__ats_lab__2opt_2postiats_2src_2pats_trans1_2esats__the_trans1errlst_finalize:
tmp13 = the_trans1errlst_get_1 () ;
tmp14 = list_vt_length_01831_ats_ptr_type (tmp13) ;
/* tmp20 = */ list_vt_free_01829_ats_ptr_type (tmp13) ;
tmp24 = atspre_igt (tmp14, 0) ;
if (tmp24) {
...
return /* (tmp12) */ ;
} /* end of [_2opt_2postiats_2src_2pats_trans1_2esats__the_trans1errlst_finalize] */

#ifdef _ATS_AVR

#define _2opt_2postiats_2src_2pats_trans1_error_2edats__staload() 
...
ats_void_type
_2opt_2postiats_2src_2pats_trans1_error_2edats__staload () {
static int _2opt_2postiats_2src_2pats_trans1_error_2edats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_trans1_error_2edats__staload_flag) return ;
_2opt_2postiats_2src_2pats_trans1_error_2edats__staload_flag = 1 ;
...
extern ats_int_type _2opt_2postiats_2src_2pats_trans1_error_2edats__dynload_flag ;

ats_void_type
_2opt_2postiats_2src_2pats_trans1_error_2edats__dynload () {
_2opt_2postiats_2src_2pats_trans1_error_2edats__dynload_flag = 1 ;
_2opt_2postiats_2src_2pats_trans1_error_2edats__staload () ;
...
/* end of [/opt/postiats/src/pats_trans1_error_dats.c] */
