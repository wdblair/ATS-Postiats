...
/*
// /opt/postiats/src/pats_trans3_error.dats: 1749(line=58, offs=5) -- 1913(line=65, offs=4)
*/
ATSstaticdec()
ats_ptr_type
...
/*
// /opt/postiats/src/pats_trans3_error.dats: 2000(line=70, offs=22) -- 2114(line=73, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_trans3_2esats__the_trans3errlst_add (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp8) ;
...
__ats_lab__2opt_2postiats_2src_2pats_trans3_2esats__the_trans3errlst_add:
...
return /* (tmp8) */ ;
} /* end of [_2opt_2postiats_2src_2pats_trans3_2esats__the_trans3errlst_add] */
...
/*
// /opt/postiats/src/pats_trans3_error.dats: 2185(line=76, offs=27) -- 2477(line=85, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_trans3_2esats__the_trans3errlst_finalize () {
/* local vardec */
// ATSlocal_void (tmp12) ;
...
__ats_lab__2opt_2postiats_2src_2pats_trans3_2esats__the_trans3errlst_finalize:
...
return /* (tmp12) */ ;
} /* end of [_2opt_2postiats_2src_2pats_trans3_2esats__the_trans3errlst_finalize] */

#ifdef _ATS_AVR

#define _2opt_2postiats_2src_2pats_trans3_error_2edats__staload() 
...
ats_void_type
_2opt_2postiats_2src_2pats_trans3_error_2edats__staload () {
static int _2opt_2postiats_2src_2pats_trans3_error_2edats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_trans3_error_2edats__staload_flag) return ;
_2opt_2postiats_2src_2pats_trans3_error_2edats__staload_flag = 1 ;
...
extern ats_int_type _2opt_2postiats_2src_2pats_trans3_error_2edats__dynload_flag ;

ats_void_type
_2opt_2postiats_2src_2pats_trans3_error_2edats__dynload () {
_2opt_2postiats_2src_2pats_trans3_error_2edats__dynload_flag = 1 ;
_2opt_2postiats_2src_2pats_trans3_error_2edats__staload () ;
...
/* end of [/opt/postiats/src/pats_trans3_error_dats.c] */
