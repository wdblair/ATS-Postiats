...
static
ats_ptr_type the_trans2errlst_get_1 () ;
static
...
/*
// /opt/postiats/src/pats_trans2_error.dats: 1749(line=58, offs=5) -- 1913(line=65, offs=4)
*/
ATSstaticdec()
ats_ptr_type
the_trans2errlst_get_1 () {
/* local vardec */
...
__ats_lab_the_trans2errlst_get_1:
...
tmp4 = tmp6 ;
return (tmp4) ;
} /* end of [the_trans2errlst_get_1] */

/*
// /opt/postiats/src/pats_trans2_error.dats: 2000(line=70, offs=22) -- 2114(line=73, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_trans2_2esats__the_trans2errlst_add (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp8) ;
...
__ats_lab__2opt_2postiats_2src_2pats_trans2_2esats__the_trans2errlst_add:
...
return /* (tmp8) */ ;
} /* end of [_2opt_2postiats_2src_2pats_trans2_2esats__the_trans2errlst_add] */
...
/*
// /opt/postiats/src/pats_trans2_error.dats: 2185(line=76, offs=27) -- 2477(line=85, offs=2)
*/
ATSglobaldec()
ats_void_type
_2opt_2postiats_2src_2pats_trans2_2esats__the_trans2errlst_finalize () {
/* local vardec */
// ATSlocal_void (tmp12) ;
...
__ats_lab__2opt_2postiats_2src_2pats_trans2_2esats__the_trans2errlst_finalize:
tmp13 = the_trans2errlst_get_1 () ;
tmp14 = list_vt_length_01831_ats_ptr_type (tmp13) ;
/* tmp20 = */ list_vt_free_01829_ats_ptr_type (tmp13) ;
tmp25 = atspre_igt (tmp14, 0) ;
if (tmp25) {
/* tmp24 = */ atspre_fprintf_exn (stderr, ATSstrcst("TRANS2: there are [%i] errors in total.\n"), tmp14) ;
} else {
/* empty */
} /* end of [if] */
...
return /* (tmp12) */ ;
} /* end of [_2opt_2postiats_2src_2pats_trans2_2esats__the_trans2errlst_finalize] */

#ifdef _ATS_AVR

#define _2opt_2postiats_2src_2pats_trans2_error_2edats__staload() 
...
ats_void_type
_2opt_2postiats_2src_2pats_trans2_error_2edats__staload () {
static int _2opt_2postiats_2src_2pats_trans2_error_2edats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_trans2_error_2edats__staload_flag) return ;
_2opt_2postiats_2src_2pats_trans2_error_2edats__staload_flag = 1 ;
...
extern ats_int_type _2opt_2postiats_2src_2pats_trans2_error_2edats__dynload_flag ;

ats_void_type
_2opt_2postiats_2src_2pats_trans2_error_2edats__dynload () {
_2opt_2postiats_2src_2pats_trans2_error_2edats__dynload_flag = 1 ;
_2opt_2postiats_2src_2pats_trans2_error_2edats__staload () ;
...
/* end of [/opt/postiats/src/pats_trans2_error_dats.c] */
