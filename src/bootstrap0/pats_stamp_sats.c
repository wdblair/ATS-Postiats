...
#define _2opt_2postiats_2src_2pats_stamp_2esats__staload() 
...
static int _2opt_2postiats_2src_2pats_stamp_2esats__staload_flag = 0 ;
if (_2opt_2postiats_2src_2pats_stamp_2esats__staload_flag) return ;
_2opt_2postiats_2src_2pats_stamp_2esats__staload_flag = 1 ;
...
/* end of [/opt/postiats/src/pats_stamp_sats.c] */
